...
@section('content')
                            ...
                            <tr>
                                ...
                                <td>
                                    @switch($student->status)
                                        ...
                                        @case(1)
                                            <span class="badge rounded-pill px-3 py-2"
                                                style="background:#6b7280; color:white; font-weight:600;">
                                                Transferred
                                            </span>
                                        @break
                                ...
                                <td>
                                    <div style="display: flex; gap: 4px;">
                                        <!-- View Button -->
                                        <a href="{{ route('account.students.show', $student->id) }}" class="btn btn-info"
                                        ...
                                        <!-- Delete Button -->
                                        <button
                                            onclick="deleteStudent({{ $student->id }}, '{{ $student->name }}', {{ $student->grades->count() ?? 0 }})"
    ...
    <script>
        ...
        document.getElementById('classFilter').addEventListener('change', function() {
            ...
            rows.forEach(row => {
                const studentClass = row.cells[3].textContent.trim();
