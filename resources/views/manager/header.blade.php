...
<body class="bg-gray-100">
    ...
    <header class="bg-white shadow-md py-3 px-6 flex justify-between items-center">
        ...
        <nav class="flex items-center space-x-6">
            <a href="{{ route('manager.index') }}" class="text-gray-700 hover:text-blue-500 font-medium">Home</a>
            <a href="{{ route('manager.reports') }}" class="text-gray-700 hover:text-blue-500 font-medium">Reports</a>
        </nav>
